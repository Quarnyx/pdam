...
<div class="container-xxl">
    ...
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-semibold m-0">Laporan Kas Masuk</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-xl-12">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Laporan Kas Masuk Periode <?php
        ...
        <div class="col-4">
            ...
            <a href="page/laporan/cetak-kas-masuk.php?dari_tanggal=<?php echo $daritanggal ?>&sampai_tanggal=<?php echo $sampaitanggal ?>"
